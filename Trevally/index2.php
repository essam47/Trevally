...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($select_cart) > 0){
      $message[] = ' !المنتج اضيف لعربة التسوق ';
   }else{
...
<div class="user-profile">
   ...
   <div class="flex">
      <a href="index2.php?logout=<?php echo $user_id; ?>" onclick="return confirm('هل أنت متأكد أنك تريد تسجيل الخروج؟');" class="delete-btn">تسجيل الخروج</a>
   </div>
